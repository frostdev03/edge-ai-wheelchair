...
void kirimPerintahKelektronik(const char* label) {
    uint8_t commandToSend = CMD_DIAM; // Default adalah diam jika deteksi berupa derau/unknown
    ...
    // Baris 'else return;' DIHAPUS. 
    // Sekarang, jika mendeteksi _noise_ atau _unknown_, 
    // eksekusi akan terus lanjut ke bawah dan mengirimkan perintah CMD_DIAM (0).
